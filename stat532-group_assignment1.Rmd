...
__Background Motivation:__ Much research has been done to look at the relative age effect in athletes in North America and Europe. However this paper (and our analysis) extends this research to include Asian countries. This is an important step in geographically extending the scope of inference regarding the relative age effect. This has impacts on parents' decisions surrounding red shirting and informs public understanding of factors influencing success in athletics (particularly professional athletics). 
